...
// Reuse is safe here BY DESIGN: the header already says the suite reports
// whatever quests the account has rather than asserting an empty journal.
const DEVICE_ID = 'verify-questwnd-fixture-1';
