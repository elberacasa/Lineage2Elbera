...
//
// WHICH id plays A (the seller) is decided at runtime by asking the database
// who currently holds the guide, because this suite SELLS it from A to B:
// run 1 sends it one way, run 2 sends it back. A hardcoded A would run out
// of guides after one pass. See live_fixture.orderByItem.
const DEVICE_IDS = ['verify-storewnd-fixture-1', 'verify-storewnd-fixture-2'];
...
(async () => {
  ...
  // A must be the one holding the guide it is about to list for sale.
